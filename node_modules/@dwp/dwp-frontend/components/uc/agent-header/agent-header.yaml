params:
  ...
  - name: disableStickyHeader
    type: boolean
    description: Removes the class to make the header sticky.
  - name: navigation
    type: array
    required: false
    ...
    params:
      ...
      - name: opensInNewWindow
        type: boolean
        required: false
        description: To determine whether or not a link opens in a new window.
  ...
  - name: classes
    type: string
    required: false
    description: Classes to add to the header HTML element.
  - name: attributes
    type: object
    required: false
    description: HTML attributes (for example data attributes) to add to the header HTML element.
  - name: action
    type: string
    required: false
    description: the action of a link
  - name: actionUrl
    type: string
    required: false
  ...
  - name: profileName
    type: string
    required: false
    description: The name of the person signed-in.
