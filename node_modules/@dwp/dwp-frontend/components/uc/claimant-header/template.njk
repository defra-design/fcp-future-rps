<header class="uc-claimant-header {%- if params.classes %} {{ params.classes }}{% endif %}"
  ...
  <div class="uc-claimant-header__container uc-width-container">
    ...
    <div class="uc-claimant-header__content">
      <div class="uc-claimant-header__service-name">
        <a href="{{ params.serviceUrl }}" class="uc-claimant-header__link">{{ params.serviceName }}</a>
      </div>
      {% if params.action %}
        <div class="uc-claimant-header__service-action">
          {% if params.profileName %}
            <span id="current-user" class="uc-claimant-header__profile">{{ params.profileName }}</span>:
          {% endif %}
          <a href="{{ params.actionUrl }}" class="uc-claimant-header__link"  {% if params.profileName %} aria-describedby="current-user"{% endif %}>{{ params.action }}</a>
        </div>
      {% endif %}
    </div>
  </div>
