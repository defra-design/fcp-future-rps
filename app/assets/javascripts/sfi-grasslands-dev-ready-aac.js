...
(function (window) {
  ...
  function getParcelProfile (parcelId, parcel) {
    ...
    if (parcel && Array.isArray(parcel.landCover)) {
      var allocatedCovers = window.SfiGrasslandsDevReadyParcelReference &&
        typeof window.SfiGrasslandsDevReadyParcelReference.allocateLandCoverAreas === 'function'
        ? window.SfiGrasslandsDevReadyParcelReference.allocateLandCoverAreas(parcel.landCover, totalHa)
        : null
  ...
  function isActionDeductionBreakdownEnabled () {
    if (window.SfiGrasslandsDevReadyFeatureToggles &&
      ...
      return window.SfiGrasslandsDevReadyFeatureToggles.isToggleEnabled('actionDeductions')
    }
    return false
  }
  ...
  window.SfiGrasslandsDevReadyAac = api
  window.SfiGrasslandsDevReadyProtectedLand = {
