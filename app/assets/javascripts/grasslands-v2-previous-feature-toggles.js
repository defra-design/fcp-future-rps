/**
 * grasslands-v2-previous: persist footer feature toggles (session + shareable URL)
 * across all pages that use the grasslands-v2-previous header layout.
 */
  ...
  function init () {
    ...
    TOGGLES.forEach(function (toggle) {
      ...
      if (toggle.journeySwitch) {
        ...
        input.checked = true
        setSessionFlag(toggle.storageKey, true)
