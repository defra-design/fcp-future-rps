...
(function (window) {
  ...
  function getParcelProfile (parcelId, parcel) {
    ...
    if (parcel && Array.isArray(parcel.landCover)) {
      var allocatedCovers = window.SfiGrasslandsV3ParcelReference &&
        typeof window.SfiGrasslandsV3ParcelReference.allocateLandCoverAreas === 'function'
        ? window.SfiGrasslandsV3ParcelReference.allocateLandCoverAreas(parcel.landCover, totalHa)
        : null
  ...
  function isActionDeductionBreakdownEnabled () {
    if (window.SfiGrasslandsV3FeatureToggles &&
      ...
      return window.SfiGrasslandsV3FeatureToggles.isToggleEnabled('actionDeductions')
    }
    return false
  }
  ...
  window.SfiGrasslandsV3Aac = api
  window.SfiGrasslandsV3ProtectedLand = {
