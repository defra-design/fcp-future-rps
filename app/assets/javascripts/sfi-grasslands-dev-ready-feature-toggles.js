/**
 * sfi-grasslands-dev-ready: persist footer feature toggles (session + shareable URL)
...
(function (window, document) {
  var TOGGLES = [
    {
      ...
      storageKey: 'sfiGrasslandsDevReadyShowAllMvpActions',
      queryParam: 'allActions'
    },
    {
      id: 'show-previous-agreements',
      storageKey: 'sfiGrasslandsDevReadyShowPreviousAgreements',
      queryParam: 'previousAgreements'
    },
    {
      id: 'show-action-deductions',
      storageKey: 'sfiGrasslandsDevReadyShowActionDeductions',
  ...
  window.SfiGrasslandsDevReadyFeatureToggles = {
