/**
 * sfi-grasslands-v4: persist footer feature toggles (session + shareable URL)
...
(function (window, document) {
  var TOGGLES = [
    {
      ...
      storageKey: 'sfiGrasslandsV4ShowAllMvpActions',
      queryParam: 'allActions',
      defaultOn: false
    },
    {
      id: 'show-previous-agreements',
      storageKey: 'sfiGrasslandsV4ShowPreviousAgreements',
      queryParam: 'previousAgreements',
      defaultOn: true
    },
    {
      id: 'show-action-deductions',
      storageKey: 'sfiGrasslandsV4ShowActionDeductions',
  ...
  window.SfiGrasslandsV4FeatureToggles = {
