/**
 * sfi-grasslands-v4: Select actions page
 *
 * Map, parcel selection, action checkboxes, quantities, and save.
 * Loaded only from app/views/sfi-grasslands-v4/select-actions.html.
 */
...
function getWholeRemainingAreaHa(actionCode) {
  ...
  if (window.SfiGrasslandsV4Aac && window.SfiGrasslandsV4Aac.isEnabled() &&
      typeof window.SfiGrasslandsV4Aac.recalculate === 'function') {
    window.SfiGrasslandsV4Aac.syncSelectionsFromDom();
    ...
    window.SfiGrasslandsV4Aac.syncSelectionsFromDom();
    var calculation = window.SfiGrasslandsV4Aac.recalculate();
    if (quantityInput) {
...
function formatExistingAgreementActionLabel(action) {
  if (window.SfiGrasslandsV4ExistingAgreements &&
    ...
    return window.SfiGrasslandsV4ExistingAgreements.formatLabel(action);
  }
  if (!action) {
    return '';
  }
...
function updatePreviousAgreementsSummary(parcelId) {
  ...
  if (!agreements.length && window.SfiGrasslandsV4ExistingAgreements) {
    var fallbackActions = window.SfiGrasslandsV4ExistingAgreements.get(parcelId) || [];
...
function formatParcelReference(parcel) {
  if (window.SfiGrasslandsV4ParcelReference && typeof window.SfiGrasslandsV4ParcelReference.format === 'function') {
    return window.SfiGrasslandsV4ParcelReference.format(parcel)
  }
  if (!parcel) {
    return ''
  }
...
function getPreviousAgreementsForParcel(parcelId) {
  ...
  if (typeof window.SfiGrasslandsV4ExistingAgreements.getAgreements === 'function') {
    return window.SfiGrasslandsV4ExistingAgreements.getAgreements(parcelId) || [];
  }
  if (typeof window.SfiGrasslandsV4ExistingAgreements.get === 'function') {
    var flatActions = window.SfiGrasslandsV4ExistingAgreements.get(parcelId) || [];
...
function getActionConsentFlags(actionCode, parcelIdOverride) {
  ...
  if (window.SfiGrasslandsV4ProtectedLand &&
      typeof window.SfiGrasslandsV4ProtectedLand.getRequirementFlags === 'function') {
    return window.SfiGrasslandsV4ProtectedLand.getRequirementFlags(actionCode, parcelId);
  }
...
function appendClig3Supplements(clig3Conditional) {
  ...
  radios.addEventListener('change', function(event) {
    ...
    } else if (window.SfiGrasslandsV4Aac && window.SfiGrasslandsV4Aac.isEnabled()) {
...
function restoreParcelState(parcelId) {
  ...
  if (window.SfiGrasslandsV4ActionsCompatibilityLoading) {
    window.SfiGrasslandsV4ActionsCompatibilityLoading.setSuspended(true);
  }
  ...
  try {
    ...
    if (window.SfiGrasslandsV4ActionsCompatibilityLoading) {
      ...
      if (!(window.SfiGrasslandsV4Aac && window.SfiGrasslandsV4Aac.isEnabled())) {
        window.SfiGrasslandsV4ActionsCompatibilityLoading.setSuspended(false);
      }
    }
...
function syncAacForCurrentParcel() {
  if (!window.SfiGrasslandsV4Aac) {
    return;
  }

  if (!window.SfiGrasslandsV4Aac.isEnabled()) {
    window.SfiGrasslandsV4Aac.setParcel(null, null, []);
  ...
  window.SfiGrasslandsV4Aac.setParcel(
...
function isPreviousAgreementsToggleOn() {
  if (window.SfiGrasslandsV4FeatureToggles &&
      typeof window.SfiGrasslandsV4FeatureToggles.isToggleEnabled === 'function') {
    return window.SfiGrasslandsV4FeatureToggles.isToggleEnabled('previousAgreements');
  }
  try {
    if (new URLSearchParams(window.location.search).get('previousAgreements') === '1') {
      return true;
    }
    var raw = window.sessionStorage.getItem('sfiGrasslandsV4ShowPreviousAgreements');
    if (raw === '1') {
      return true;
    }
    if (raw === '0') {
...
function updateAacParcelAreaBreakdown() {
  ...
  var aacOn = window.SfiGrasslandsV4Aac && window.SfiGrasslandsV4Aac.isEnabled();
  if (bottomPanels) {
  ...
  if (typeof window.SfiGrasslandsV4Aac.getParcelAreaBreakdown !== 'function') {
    container.hidden = true;
    hideAacPreviousAgreementsDetails();
    updateAacActionsIntro();
    return;
  ...
  var breakdown = window.SfiGrasslandsV4Aac.getParcelAreaBreakdown(
    currentSelectedParcel,
    parcel
  );
  ...
  if (landCoverEl) {
    if (landCovers.length) {
      ...
      var fallbackCovers = window.SfiGrasslandsV4ParcelReference &&
        typeof window.SfiGrasslandsV4ParcelReference.allocateLandCoverAreas === 'function'
        ? window.SfiGrasslandsV4ParcelReference.allocateLandCoverAreas(fallbackNames, fallbackTotal)
...
$(document).ready(function(){
  ...
  function validateBeforeSave() {
    if (window.SfiGrasslandsV4Aac && window.SfiGrasslandsV4Aac.isEnabled() && window.SfiGrasslandsV4Aac.isBusy()) {
      return false;
    }
  ...
  selectParcel = function(parcelId) {
    if (window.SfiGrasslandsV4ActionsCompatibilityLoading) {
      window.SfiGrasslandsV4ActionsCompatibilityLoading.reset();
    }
    ...
    if (parcelData[parcelId] && !(window.SfiGrasslandsV4Aac && window.SfiGrasslandsV4Aac.isEnabled())) {
      var parcel = parcelData[parcelId];
      $('.govuk-checkboxes__conditional').each(function() {
        var $conditional = $(this);
        var $suffix = $conditional.find('.govuk-input__suffix');
    ...
    if (window.SfiGrasslandsV4Aac && window.SfiGrasslandsV4Aac.isEnabled()) {
      ...
      if (window.SfiGrasslandsV4ActionsCompatibilityLoading) {
        if (typeof window.SfiGrasslandsV4ActionsCompatibilityLoading.setSuspended === 'function') {
          window.SfiGrasslandsV4ActionsCompatibilityLoading.setSuspended(true);
        }
        if (typeof window.SfiGrasslandsV4ActionsCompatibilityLoading.resetCompatibilityState === 'function') {
          window.SfiGrasslandsV4ActionsCompatibilityLoading.resetCompatibilityState();
        }
      }
      syncAacForCurrentParcel();
    } else {
  ...
  function findExistingAgreementConflict(candidateCode) {
    if (!window.SfiGrasslandsV4ExistingAgreements || typeof window.SfiGrasslandsV4ExistingAgreements.get !== 'function') {
      return null;
    }
    ...
    var existingActions = window.SfiGrasslandsV4ExistingAgreements.get(parcelId);
  ...
  function updateCompatibilityState() {
    var loading = window.SfiGrasslandsV4ActionsCompatibilityLoading;
    if (
      loading &&
  ...
  function isFeatureToggleEnabled(queryParam, storageKey, defaultOn) {
    if (window.SfiGrasslandsV4FeatureToggles &&
        typeof window.SfiGrasslandsV4FeatureToggles.resolveToggleEnabled === 'function') {
      return window.SfiGrasslandsV4FeatureToggles.resolveToggleEnabled(queryParam);
    }
  ...
  // AAC is always on in sfi-grasslands-v4 (not a feature toggle).
  ...
  function setAacModeEnabled(enabled) {
    ...
    window.SfiGrasslandsV4Aac.setEnabled(enabled);
    updateActionsModeIntro(enabled);

    if (window.SfiGrasslandsV4ActionsCompatibilityLoading &&
        typeof window.SfiGrasslandsV4ActionsCompatibilityLoading.setSuspended === 'function') {
      window.SfiGrasslandsV4ActionsCompatibilityLoading.setSuspended(enabled);
    }
    ...
    if (enabled) {
      ...
      if (
        window.SfiGrasslandsV4ActionsCompatibilityLoading &&
        typeof window.SfiGrasslandsV4ActionsCompatibilityLoading.updateCompatibility === 'function'
      ) {
        window.SfiGrasslandsV4ActionsCompatibilityLoading.updateCompatibility(null);
      } else {
        updateCompatibilityState();
      }
    }
  ...
  function wireAacToggles() {
    ...
    // AAC is always enabled in sfi-grasslands-v4
    setSessionFlag('sfiGrasslandsV4UseAac', true);
    setSessionFlag('sfiGrasslandsV4AacDebug', false);

    window.SfiGrasslandsV4Aac.init({
      enabled: true,
      debug: false,
  ...
  function wireShowAllMvpActionsToggle() {
    var showAllMvpActionsStorageKey = 'sfiGrasslandsV4ShowAllMvpActions';
  ...
  function wireActionDeductionsToggle() {
    var storageKey = 'sfiGrasslandsV4ShowActionDeductions';
  ...
  function wirePreviousAgreementsToggle() {
    var storageKey = 'sfiGrasslandsV4ShowPreviousAgreements';
  ...
  function wireCnum2UnavailableToggle() {
    ...
    setSessionFlag('sfiGrasslandsV4GreyOutCnum2', false);
    applyGreyOutCnum2();
  }

  if (window.SfiGrasslandsV4ActionsCompatibilityLoading) {
    // Compatibility updates are immediate — no simulated API delay
    setSessionFlag('sfiGrasslandsV4SimulateCompatibilityApiDelay', false);

    window.SfiGrasslandsV4ActionsCompatibilityLoading.init({
      simulateDelay: false,
  ...
  function triggerAacQuantityUpdate(inputEl) {
    if (!(window.SfiGrasslandsV4Aac && window.SfiGrasslandsV4Aac.isEnabled()) || !inputEl) {
      return;
    }
